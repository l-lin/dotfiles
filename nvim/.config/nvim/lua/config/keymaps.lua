-- Default keymaps copied from: https://github.com/LazyVim/LazyVim/blob/main/lua/lazyvim/config/keymaps.lua
...
-- NOTE: Navigator plugin is in charge of navigating between windows and multiplexers
