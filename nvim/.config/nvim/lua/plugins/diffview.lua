...
require("diffview").setup({
    ...
    view = {
        ...
        --    |"diff3_mixed"
        --    |"diff4_mixed"
        -- For more info, see "<cmd>h diffview-config-view.x.layout".
        default = {
    ...
    file_panel = {
        ...
        win_config = { -- See "<cmd>h diffview-config-win_config"
            position = "left",
            width = 35,
            win_opts = {}
        },
    ...
    file_history_panel = {
        log_options = { -- See "<cmd>h diffview-config-log_options"
            git = {
                single_file = {
    ...
    hooks = {}, -- See "<cmd>h diffview-config-hooks"
    keymaps = {
        ...
        view = {
            ...
            { "n", "<leader>g_", actions.conflict_choose("base"), { desc = "Choose the BASE version of a conflict" } },
            { "n", "<leader>ge", actions.conflict_choose("all"), { desc = "Choose all the versions of a conflict" } },
