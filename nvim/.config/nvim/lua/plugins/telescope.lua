...
map("n", "<leader>fa", "<cmd>Telescope live_grep<CR>",
  { noremap = true, desc = "Find pattern in all files" })
map("n", "<M-f>", "<cmd>Telescope live_grep<CR>",
  { noremap = true, desc = "Find pattern in all files (Alt+f)" })
map("n", "<leader>fb", "<cmd>Telescope buffers<CR>",
  { noremap = true, desc = "Find file in buffer" })
map("n", "<C-e>", "<cmd>Telescope buffers<CR>",
  { noremap = true, desc = "Find file in buffer (Ctrl+e)" })

-- history
map("n", "<leader>f/", "<cmd>Telescope search_history<CR>",
  { noremap = true, desc = "Find in search history" })

-- misc
map("n", "<leader>f:", "<cmd>Telescope commands<CR>",
  { noremap = true, desc = "Find nvim command" })
map("n", "<leader>fh", "<cmd>Telescope help_tags<CR>",
  { noremap = true, desc = "Find help tags" })
map("n", "<leader>fk", "<cmd>Telescope keymaps<CR>",
  { noremap = true, desc = "Find nvim keymap" })
map("n", "<leader>fo", "<cmd>Telescope vim_options<CR>",
  { noremap = true, desc = "Find vim option" })
map("n", "<leader>fs", "<cmd>Telescope luasnip<CR>",
  { noremap = true, desc = "Find snippet" })
...
map("n", "<leader>fy", "<cmd>Telescope yank_history<CR>",
  { noremap = true, silent = true, desc = "Find in yank history" })

-- text
map("n", "<leader>fti", "<cmd>Telescope current_buffer_fuzzy_find<CR>",
  { noremap = true, desc = "Find string in current buffer" })
map("n", "<leader>ftg", "<cmd>Telescope grep_string<CR>",
  { noremap = true, desc = "Find string in path" })
map("n", "<leader>fts", "<cmd>Telescope spell_suggest<CR>",
  { noremap = true, desc = "Spelling suggestions for current word under cursor" })
...
map("n", "<C-b>", "<cmd>Telescope lsp_definitions<CR>",
  { noremap = true, desc = "Goto definition (Ctrl+b)" })
map("n", "<leader>cD", "<cmd>Telescope diagnostics<CR>",
  { noremap = true, desc = "Diagnostic" })
map("n", "<M-6>", "<cmd>Telescope diagnostics<CR>",
  { noremap = true, desc = "Diagnostic (Alt+6)" })
map("n", "<leader>ci", "<cmd>Telescope lsp_implementations<CR>",
  { noremap = true, desc = "Goto implementation" })
map("n", "<M-C-B>", "<cmd>Telescope lsp_implementations<CR>",
  { noremap = true, desc = "Goto implementation (Ctrl+Alt+b)" })
map("n", "<leader>ct", "<cmd>Telescope lsp_type_definitions<CR>",
  { noremap = true, desc = "Goto type definition" })
map("n", "<leader>cR", "<cmd>lua require'telescope'.extensions.refactoring.refactors()<CR>",
  { noremap = true, silent = true, desc = "Refactor" })
map("n", "<leader>cu", "<cmd>Telescope lsp_references<CR>",
  { noremap = true, desc = "Goto LSP reference" })
map("n", "<M-&>", "<cmd>Telescope lsp_references<CR>",
  { noremap = true, desc = "Goto LSP reference (Ctrl+Alt+7)" })
map("n", "<leader>cv", "<cmd>Telescope treesitter<CR>",
  { noremap = true, desc = "Treesitter symbol" })
map("n", "<F36>", "<cmd>Telescope treesitter default_text=function<CR>",
  { noremap = true, desc = "Find function (Ctrl+F12)" })
...
map("n", "<leader>fgb", "<cmd>Telescope git_branches<CR>",
  { noremap = true, desc = "Telescope in branches" })
map("n", "<leader>fgc", "<cmd>Telescope git_commits<CR>",
  { noremap = true, desc = "Telescope in commits" })
map("n", "<leader>fgC", "<cmd>Telescope git_bcommits<CR>",
  { noremap = true, desc = "Telescope current buffer commit history" })
...
map("n", "<leader>fgs", "<cmd>Telescope git_status<CR>",
  { noremap = true, desc = "Telescope modified git files" })
map("n", "<leader>fgt", "<cmd>Telescope git_stash<CR>",
  { noremap = true, desc = "Telescope git stash" })

-- DAP
map("n", "<leader>dc", "<cmd>Telescope dap configurations<CR>",
  { noremap = true, silent = true, desc = "Telescope DAP configurations" })
