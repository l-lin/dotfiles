--[[
    ...
    There is a bug on the original net widget where the devices must be set.
    The fix is in this [PR](https://github.com/lcpz/lain/pull/559/files) which I directly copied here.
--]]
