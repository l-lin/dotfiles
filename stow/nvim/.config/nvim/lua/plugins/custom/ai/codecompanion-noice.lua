-- Show progress in Noice when a request is being sent to an LLM.
-- src: https://github.com/olimorris/codecompanion.nvim/discussions/813#discussioncomment-12289384
