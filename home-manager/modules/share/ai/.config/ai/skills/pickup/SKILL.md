...
- If empty: Present the list handoff files in `.sandbox/handoffs` and use `ask-user-quest` tool to ask the user which handoff file you need to resume work from.
