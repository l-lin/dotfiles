...
2. Interview the user using `ask-user-question` tool before changing anything. Cover all four: **trigger**, **structure**, **steering**, **pruning**. Use `references/SKILL-CHECKLIST.md`.
