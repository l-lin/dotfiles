...
const messages = [
  ...
  "Calculating velocity (it's zero)...",
  "Inflating story points...",
  "Grooming backlog (still a mess)...",
  ...
  "Jnjecting SQL (prevention)...",
  "Asserting SAML nonsense...",
  "Querying LDAP the void...",
  "Database connection pooling tears...",
  "Transaction rolling back...",
  "Isolation level: Chaos...",
  "Index missing (of course)...",
  "Optimizing query (not)...",
  "Multiplying N+1 problem...",
  "Full table scanning...",
  "Lock escalating...",
  "Violating constraint...",
  "Praising the Sun...",
  "FUS RO DAH-ing through errors...",
  "Touching grass...",
  "Catching 'em all (bugs)...",
  "It's super effective!...",
  "Taking an arrow to the knee...",
  "Parrying your bad code...",
  "A wild exception appeared!...",
  "Pokemon fainted (it's your build)...",
  "Resting at bonfire...",
  "Riposting your expectations...",
  "Using potion on your tech debt...",
  "Collecting golden rings...",
  "It's-a me, fixing bugs...",
  "Stomping Goombas in your codebase...",
  "Princess is in another castle...",
  "Playing Song of Time (wasting it)...",
  "Activating Master Sword debug mode...",
  "Slaying demons in prod...",
  "Hadouken!...",
  "COMBO x47 (errors)...",
  "Perfect parry executed...",
  "Ultra instinct activating...",
  "Brutality performed on codebase...",
  "Zerg rushing to deadline...",
  "GG EZ (it's not)...",
  "Need more vespene gas...",
  "Limit break charging...",
  "Summoning Bahamut on this bug...",
  "Phoenix Down not found...",
  "Casting Ultima on your codebase...",
  "! Exclamation point detected...",
  "I need healing (so does this code)...",
  "Leeroy Jenkins-ing the deploy...",
  "This is fine...",
  "Just as planned...",
  "Rebooting dignity...",
];
