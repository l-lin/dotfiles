/**
 * file-mutation-events — shared contract for write/edit tool event bus messages.
 *
 ...
 *
 * Dependents:
 *   - lsp-diagnostics: emits FILE_MUTATION_DIAGNOSTICS_CHANNEL after every write/edit
...
export const FILE_MUTATION_DIAGNOSTICS_CHANNEL = "file-mutation-events:diagnostics";

/**
 * Payload emitted on `FILE_MUTATION_DIAGNOSTICS_CHANNEL` after a write/edit
 ...
 */
export interface FileMutationDiagnosticsEvent {
