---@class dotfiles.mermaid.sequence.Graph
---@field actors table[] List of actors in the diagram.
---@field actor_ids table<string, boolean> Set of actor IDs for quick lookup.
