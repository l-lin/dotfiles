local function setup()
  ...
  vim.keymap.set("n", "<leader>or", function() require("functions.lang.obsidian.random_note").open("3-resources/technical-notes") end, { desc = "Debug random note", noremap = true })
