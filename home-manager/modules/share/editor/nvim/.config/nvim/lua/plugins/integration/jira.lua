...
local function setup()
  ...
  vim.keymap.set("n", "<leader>j1", "<cmd>Jira epic P3C-6916<cr>", { desc = "Jira P3C-6916" })
  vim.keymap.set("n", "<leader>j2", "<cmd>Jira epic P3C-6999<cr>", { desc = "Jira P3C-6999" })
  vim.keymap.set("n", "<leader>j2", "<cmd>Jira epic P3C-7584<cr>", { desc = "Jira P3C-7584" })
