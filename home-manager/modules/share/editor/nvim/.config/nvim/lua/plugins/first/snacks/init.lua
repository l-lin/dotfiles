    ...
    picker = {
      ...
      sources = {
        ...
        gh_diff = {
          ...
          actions = {
            gh_diff_tree_actions = gh_diff_tree.gh_actions,
            gh_diff_tree_close = gh_diff_tree.close,
            gh_diff_tree_comment = gh_diff_tree.gh_comment,
          ...
          win = {
            list = {
              keys = {
                ...
                ["<M-a>"] = { "gh_diff_tree_actions", mode = { "n", "x" } },
              },
            },
            preview = {
              keys = {
                ["H"] = { "focus_list", mode = { "n" } },
                ["a"] = { "gh_diff_tree_comment", mode = { "n", "x" } },
                ["<M-c>"] = { "gh_diff_tree_comment", mode = { "n", "x" } },
                ["<cr>"] = { "gh_diff_tree_actions", mode = { "n", "x" } },
                ["<M-a>"] = { "gh_diff_tree_actions", mode = { "n", "x" } },
              },
            },
          },
