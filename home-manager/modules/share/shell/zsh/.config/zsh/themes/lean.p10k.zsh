# Generated by Powerlevel10k configuration wizard on 2024-02-03 at 16:19 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#76946a'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#c34043'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%65F'   # green foreground
  ...
  ####################[ java_version: java version (https://www.java.com/) ]####################
  # Java version color.
  typeset -g POWERLEVEL9K_JAVA_VERSION_FOREGROUND=124
