...
local function keys()
  return gears.table.join(
    ...
    awful.key({ config.modkey, "Control" }, "l", function(c) c:move_to_screen(c.screen.index + 1) end, { description = "move to right screen", group = "client" }),
    awful.key({ config.modkey, "Control" }, "h", function(c) c:move_to_screen(c.screen.index - 1) end, { description = "move to left screen", group = "client" }),
