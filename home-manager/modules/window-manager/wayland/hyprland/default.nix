...
exec = pkill swaybg; sleep 0.5; swaybg -i ${config.theme.backgroundImage} -m center
...
# Make IntellIJ floating windows opaque, otherwise code completion is not readable
windowrulev2 = opaque, class:^(jetbrains-idea-ce)$, floating:1
